...
], Documento.prototype, "proyecto", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => usuarios_entity_1.Usuario, { nullable: false }),
    __metadata("design:type", usuarios_entity_1.Usuario)
], Documento.prototype, "usuario", void 0);
__decorate([
    (0, typeorm_1.Column)({ default: 'privado' }),
    __metadata("design:type", String)
], Documento.prototype, "permiso", void 0);
